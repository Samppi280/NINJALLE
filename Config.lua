...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/txg2f0E.png",
...
Config.Languages = {
  ['en'] = {
        ...
        ['favoriteinfo'] = "Valitse animaatio täältä ja aseta se suosikkeihisi!",
        ['rfavorite'] = "Palauta suosikit",
        ['prop2info'] = "❓ Prop Emotes can be located at the end",
        ['set'] = "Aseta (",
        ['setboundemote'] = ") bindataksesi emote?",
        ['newsetemote'] = "~w~ on nyt sinun bindattu emote! Paina ~g~CapsLock~w~ käyttääksesi sitä.",
        ['cancelemote'] = "Lopeta animaatio",
        ['cancelemoteinfo'] = "Paina ~r~X~w~ 'Lihasta' Lopettaaksesi kyseisen animaation",
        ['walkingstyles'] = "Kävely tyylit",
        ['resetdef'] = "Aseta vakioksi",
        ['normalreset'] = "Normaali (Vakio)",
        ['moods'] = "Ilmeet",
        ['infoupdate'] = "Päivitykset",
        ['infoupdateav'] = "Päivitykset (Päivitys saatavilla!)",
        ['infoupdateavtext'] = "Uusi päivitys dpEmoteista on saatavilla! Ota yhteys serverin kehittäjään!",
        ['suggestions'] = "Ongelmia?",
        ['suggestionsinfo'] = "Ota yhteyttä @Mazkyy discordissa! Hän voi muunmuassa auttaa sinua emote ongekmien kanssa!✉️",
        ['notvaliddance'] = "Kyseistä tanssi animaatiota ei ole olemassakaan",
        ['notvalidemote'] = "Kyseistä animaatiota ei ole olemassakaan",
        ['nocancel'] = "Et suorita animaatioita joita pystyisi keskeyttämään...",
        ['maleonly'] = "Tämä animaatio on miehille vain, Pahoittelut!",
        ['emotemenucmd'] = "Do /emotemenu for a menu.",
        ['shareemotes'] = "👫 Pari animaatiot",
        ['shareemotesinfo'] = "Pyydä lähintä pelaajaa kanssasi tekemään taikoja!",
        ['sharedanceemotes'] = "🕺 Tanssit",
        ['notvalidsharedemote'] = "is not a valid shared emote.",
        ['sentrequestto'] = "Pyyntö lähetetty pelaajalle: ~y~",
        ['nobodyclose'] = "Pelaajia ~r~ei ole~w~ lähettyvillä...",
        ['doyouwanna'] = "Paina ~y~Y~w~ hyväksyäksesi, Tai ~r~L~w~ hylkääksesi (~g~",
        ['refuseemote'] = "Emote hylättiin...",
        ['makenearby'] = "makes the nearby player play",
        ['camera'] = "Paina ~y~G~w~ ottaaksesi kuvia",
        ['makeitrain'] = "Paina ~y~G~w~ heittääksesi rahaa ilmaan",
        ['pee'] = "Paina ~y~G~w~ pissataksesi",
        ['spraychamp'] = "Paina ~y~G~w~ suihkutaaksesi shanmpanjaa",
        ['bound'] = "Bound ",
        ['to'] = "to",
        ['currentlyboundemotes'] = " Currently bound emotes:",
        ['notvalidkey'] = "is not a valid key.",
        ['keybinds'] = "🔢 Näppäinbindit",
        ['keybindsinfo'] = "Käytä"
  },
  ['fr'] = {
        ['emotes'] = 'Emotes',
